	...
	public function getDefaultStatuses(): array {
		return [
			[
				'id' => self::MEETING,
				'icon' => '📅',
				'message' => $this->l10n->t('In a meeting'),
				'clearAt' => [
					'type' => 'period',
					'time' => 3600,
				],
			...
			[
				'id' => self::VACATIONING,
				'icon' => '🌴',
				'message' => $this->l10n->t('Vacationing'),
				'clearAt' => null,
			],
			[
				'id' => self::REMOTE_WORK,
				'icon' => '🏡',
				'message' => $this->l10n->t('Working remotely'),
				'clearAt' => [
					'type' => 'end-of',
					'time' => 'day',
				],
